...
- [Running CNNeoPP (End-to-End)](#running-cnneopp-end-to-end)
...
(Optional) Create the conda environment for reproducibility:
...
All model weights and parameters used in the manuscript are provided. A tagged release corresponding to the manuscript version is recommended.
